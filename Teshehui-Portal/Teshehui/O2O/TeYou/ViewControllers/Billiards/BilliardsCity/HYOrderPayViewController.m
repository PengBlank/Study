    ...
    [self.checkCardStatusReqeust sendReuqest:^(id result, NSError *error)
     {
         ...
         if(result){
             ...
             if (code == 0) { //状态值为0 代表请求成功
                 ...
                 NSString *remindMoney = objKeyValue[@"card"]; //充值卡余额
                 ...
                 if(remindMoney.floatValue >= money.floatValue){
                 ...
                 if(remindMoney.floatValue < money.floatValue){ //充值卡余额不足
