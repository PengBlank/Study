...
//                 
//                 if(weakSelf.orderType == BusinessComment){
//                     [[NSNotificationCenter defaultCenter] postNotificationName:kNotificationWithOrderListCommentChanged object:nil];   //  发现订单
//                     
//                 }else if(weakSelf.orderType == TravelComment){
//                     [[NSNotificationCenter defaultCenter] postNotificationName:kNotificationWithTravelOrderListCommentChanged object:nil]; // 旅游订单
//                     
//                 }else{
//                     [[NSNotificationCenter defaultCenter] postNotificationName:kNotificationWithBilliardsOrderCommentChanged object:nil]; // 桌球订单订单
//                 }
