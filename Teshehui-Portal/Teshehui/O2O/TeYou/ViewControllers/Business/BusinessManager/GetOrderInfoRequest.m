...
@implementation GetOrderInfoRequest
...
//    {
//        
//        [newDic setObject:[NSString stringWithFormat:@"%@", self.UId]
//                   forKey:@"UserId"];
//        
//    }
//
...
- (NSMutableDictionary *)getJsonDictionary
{
    ...
    if (newDic && (NSNull *)newDic != [NSNull null])
    {
        NSDictionary *tmpDic = @{@"UserId":self.UId};
        
        NSString *token = CenterToken; // 商家列表token
        NSString *action = @"";
