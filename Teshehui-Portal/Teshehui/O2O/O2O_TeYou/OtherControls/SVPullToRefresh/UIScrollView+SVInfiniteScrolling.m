...
//        [self.infiniteScrollingView resetScrollViewContentInset]; //xkun 增加
...
- (UIView *)viewForStateLoading{
    ...
    //提示文字
    _loadingLabel = [[UILabel alloc] initWithFrame:CGRectMake(kScreen_Width/2-30, (CGRectGetHeight(customView.frame)-25)/2, 100, 25)];
    _loadingLabel.textColor = [UIColor lightGrayColor];
    _loadingLabel.font = [UIFont systemFontOfSize:16];
    _loadingLabel.textAlignment = NSTextAlignmentCenter;
    _loadingLabel.text = @"正在加载中…";
    [customView addSubview:_loadingLabel];
