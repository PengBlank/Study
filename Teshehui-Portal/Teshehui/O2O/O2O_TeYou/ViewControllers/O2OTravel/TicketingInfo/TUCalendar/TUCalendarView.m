...
//限制时间
- (void) setLimitDays:(NSInteger)limitDays {
    self->_limitDays         = limitDays;
    NSTimeInterval limitTime = 24 * 60 * 60 *limitDays;
    self->_dateLimit         = [[NSDate alloc] initWithTimeIntervalSinceNow:limitTime];
}
