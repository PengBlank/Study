...
- (void)commonInit
{
    ...
    yearLabel.font = [UIFont systemFontOfSize:17.0f];
    yearLabel.textColor = TUCalendar_GlobalGrayColor;
...
- (void)setCurrentDate:(NSDate *)currentDate
{
    ...
    yearLabel.text  = [NSString stringWithFormat:@"%@年%@月",[dateStr substringFromIndex:indexSep],[dateStr substringToIndex:indexSep]];
}
