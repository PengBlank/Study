...
@implementation BuyGoodsRequest
...
- (NSMutableDictionary *)getJsonDictionary
{
    ...
    if (newDic && (NSNull *)newDic != [NSNull null])
    {
        ...
        NSDictionary *tmpDic = @{@"merId" :self.merId.length > 0 ? self.merId : @"",
                                 @"uId" : self.uId.length > 0 ? self.uId : @"",
                                 @"orId" : self.orderId.length > 0 ? self.orderId : @"",
