...
#define ShareUrl    @"http://life-api.o2o.teshehui.com/SenceView/Index?t=%@&oid=%@"
...
#define BILLIARDS_API_URL           @"http://zq-api.o2o.teshehui.com/V3"  //桌球模块
...
#define kNotificationWithSceneOrderStatusChanged            @"kNotificationWithSceneOrderStatusChanged"  // 场景订单列表刷新状态

#define kNotificationWithMainTableViewClick                 @"kNotificationWithMainTableViewClick"  // 首页点击cell
#define kNotificationWithSelecteCityBlock                   @"kNotificationWithSelecteCityBlock"  // 选择城市
#define kNotificationWithShareBlock                         @"kNotificationWithShareBlock"        //首页分享
#define kNotificationHideMainPageNavRightItem               @"kNotificationHideMainPageNavRightItem"        //隐藏首页导航item
#define kNotificationHideCategoryMenuItem                   @"kNotificationHideCategoryMenuItem"        //隐藏首页导航item
...
{
    TravelPay    = 1, //旅游支付    -->TicketPaySuccessViewController;
    BusinessPay  = 2, //实体店支付  -->PaySuccessViewController;
    BilliardsPay = 3, //桌球支付    -->PaySuccessViewController;
    CateringPay  = 4, //快餐支付    -->PrepaySuccessViewController;
    ScenePay     = 5  //场景支付    -->PayResultOfSceneCtrl;
};

typedef NS_ENUM(NSInteger, O2OBusinessType)
{
    O2OShop         = 1, //普通商家
    billiardsShop   = 2, //桌球商家
    CateringShop    = 3, //快餐商家
    SceneShop       = 4  //场景商家
};
...
typedef NS_ENUM(NSInteger, O2OCommentType)
{
    ...
    BusinessComment     = 1, //实体点商家评论
    TravelComment       = 2, //旅游商家评论
    BilliardsComment    = 3  //桌球商家评论
    
};

typedef NS_ENUM(NSInteger, O2OOrderType)
{
    
    BusinessOrder     = 1, //实体点商家订单
    TravelOrder       = 2, //旅游商家订单
    BilliardsOrder    = 3  //桌球商家订单
    
};

typedef NS_ENUM(NSInteger, O2OBackType)
{
    BusinessDetail      = 0, //商家详情
    RootCtrl            = 1 //商家详情
};
