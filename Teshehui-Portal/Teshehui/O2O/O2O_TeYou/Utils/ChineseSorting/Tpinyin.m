...
// 修改197行 mzmm 改为mcmm   187行slzy 改为 slcy
...
char pinyinFirstLetter(unsigned short hanzi)
{
	...
	{
//         char str  = firstLetterArray[index - 1];
//         char str1 = firstLetterArray[index];
//         char str2 = firstLetterArray[index + 1];
//         char str3 = firstLetterArray[index - 2];
