...
@protocol SKSTableViewCellDelegate;

@interface SKSTableViewCell : UITableViewCell

@property (nonatomic, weak) id <SKSTableViewCellDelegate> exDelegate;
/**
...
@protocol SKSTableViewCellDelegate <NSObject>

@optional
- (void)didExpandableCell:(SKSTableViewCell *)cell;
