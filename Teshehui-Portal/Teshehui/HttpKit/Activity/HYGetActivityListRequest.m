...
@interface HYGetActivityListRequest ()

@property (nonatomic,copy) NSString *reqParam;

@end

@implementation HYGetActivityListRequest
...
{
    HYGetActivityListResponse *respose = [[HYGetActivityListResponse alloc]initWithJsonDictionary:info];
    return respose;
}
@end
