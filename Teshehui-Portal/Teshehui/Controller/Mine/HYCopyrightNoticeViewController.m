//
//  HYCopyrightNoticeViewController.m
//  Teshehui
//
...
@interface HYCopyrightNoticeViewController ()<UIWebViewDelegate>
{
...
@implementation HYCopyrightNoticeViewController
...
-(void)getHomeList
{
    ...
    _linkRequest.type = CoyprightInfo;
