...
- (void)setModel:(MessageModel *)model
{
    ...
    NSString *img_url = [itemDic objectForKey:@"img_url"];
    [_cimageView sd_setImageWithURL:[NSURL URLWithString:img_url]
                   placeholderImage:[UIImage imageNamed:@"imageDownloadFail.png"]];
}
