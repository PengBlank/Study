...
NSString* const NetworkRequestErrorDomain = @"网络请求出现异常";//@"ASIHTTPRequestErrorDomain";
...
//                                      [NSNumber numberWithBool:YES], kCFStreamSSLAllowsAnyRoot,
                                      ...
                                      kCFNull,kCFStreamSSLPeerName,
                                           @"kCFStreamSocketSecurityLevelTLSv1_0SSLv3", kCFStreamSSLLevel, //添加的该行 charse 2014-05-06
                                      nil];
